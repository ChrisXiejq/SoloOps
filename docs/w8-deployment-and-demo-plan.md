...
| SQLite | 项目默认 | 单机开发持久化 | 必须 |
| PostgreSQL | Docker Compose 或 RDS | 准生产验证 | 推荐 |
...
| RDS PostgreSQL | 1C/2G 或 Serverless | 保存 scan/finding/approval/audit/agent_runs | 中 |
...
SOLOOPS_DATABASE_URL=sqlite:///./.soloops/soloops.db
